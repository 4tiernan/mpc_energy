...
def render_sidebar():
    ...
    st.sidebar.divider()
    if st.sidebar.button("🔄 Restart MPC Energy", help="Restarts the main MPC integration. Changes take effect after restart; you can continue configuring other pages before restarting.", width='stretch'):
