...
brand_defaults = {
    ...
    "Goodwe": {
        ...
        "battery_max_discharge_power_limit_entry": "number.battery_max_discharge_limit",
        "battery_max_charge_power_limit_entry": "number.battery_max_charge_limit",
        "inverter_max_power_limit_entry": "",
        "load_power_entity_id": "sensor.load_power",
        "solar_power_entity_id": "sensor.pv_power",
        ...
        "ems_control_mode_entity_id": "select.ems_mode",
        "ems_power_limit_entity_id": "number.ems_power_limit",
        "grid_export_limit_switch_entity_id": "switch.grid_export_limit_switch",
        "export_limiter_entity_id": "number.grid_export_limit",
        "battery_power_sign_convention": "- Charge, + Discharge"
    },
    "Other": {
        "estimated_daily_load_energy_consumption": 24.0,
