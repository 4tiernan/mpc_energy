...
battery_soc_entity_id = get_val("battery_soc_entity_id")
battery_stored_energy_entity_id = get_val("battery_stored_energy_entity_id")
battery_kwh_till_full_entity_id = get_val("battery_kwh_till_full_entity_id")
plant_solar_kwh_today_entity_id = get_val("plant_solar_kwh_today_entity_id")
plant_daily_load_kwh_entity_id = get_val("plant_daily_load_kwh_entity_id")
